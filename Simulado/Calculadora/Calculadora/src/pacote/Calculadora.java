...
public class Calculadora implements ActionListener, KeyListener {
	...
	private void initialize() {
		...
		panel_Excluir.setBounds(0, 66, 305, 51);
		...
		panel_Teclado.setBounds(0, 117, 305, 218);
		...
		btn_Ponto.setBounds(62, 55, 60, 54);
		btn_Ponto.setForeground(SystemColor.controlText);
		panel_Teclado.add(btn_Ponto);

		btn_1 = new JButton("1");
		btn_1.setBounds(122, 55, 60, 54);
		btn_1.setForeground(SystemColor.controlText);
		panel_Teclado.add(btn_1);

		btn_2 = new JButton("2");
		btn_2.setBounds(182, 55, 60, 54);
		btn_2.setForeground(SystemColor.controlText);
		panel_Teclado.add(btn_2);

		btn_3 = new JButton("3");
		btn_3.setBounds(242, 55, 60, 54);
		btn_3.setForeground(SystemColor.controlText);
		panel_Teclado.add(btn_3);

		btn_Logaritmo = new JButton("L");
		btn_Logaritmo.setBounds(62, 109, 60, 108);
		btn_Logaritmo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			}
		});
		
				btn_Potencia = new JButton("ˆ");
				btn_Potencia.setBounds(2, 109, 60, 54);
				btn_Potencia.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
					}
				});
		...
		for (Component c : panel_Excluir.getComponents()) {
			((JButton) c).setBackground(new Color(30, 80, 50));
			((JButton) c).setBorder(new LineBorder(new Color(90, 90, 90), 1));
			((JButton) c).addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "√":
			...
			break;
		case "=":
			if (CalculadoraOp.getOperacao().toString().equals("ˆ")) {
				CalculadoraOp.potencia();
			} else if (CalculadoraOp.getOperacao().toString().equals("L")) {
				CalculadoraOp.log();
			} else if (CalculadoraOp.getOperacao().toString().equals("√")) {
				CalculadoraOp.raiz();
			} else {
