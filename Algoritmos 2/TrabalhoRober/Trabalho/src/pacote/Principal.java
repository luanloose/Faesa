	...
	public static void main(String[] args) {
		...
		do {
			...
			case 4:
				...
				System.out.println("Digite codigo do emprestimo:");
				codEmprestimo = scan.nextInt();
				
				System.out.println("Digite codigo do aluno:");
				int codAluno = scan.nextInt();
				
				System.out.println("Digite dias de atraso:");
				int data = scan.nextInt();
				
				arquivo.lerDevolucao("aluno","emprestimo",codEmprestimo,codAluno,data);

				
				//digitar cod do emprestimo e codigo do aluno e localizar emprestimo e itens
			...
			case 9:
				...
				//inserir codigo do aluno e imprimir a linha dele
